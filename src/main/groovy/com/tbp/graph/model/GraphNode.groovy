...
class GraphNode {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "graph_node_seq")
    @SequenceGenerator(name="graph_node_seq", sequenceName = "graph_node_seq", allocationSize = 1)
    Long id
